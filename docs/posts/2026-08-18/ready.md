# Post ready — 2026-08-18

> Auto-generated from snapshot 2026-08-18. Copy-paste each section to publish.
> 📸 **Attach image (LinkedIn/X):** `visual.png` (same folder, 1200x630 chart).

## X (Twitter)

Tokenized MMFs: $10.85B across 15 EU/US funds (2026-08-18)
🥇 USYC $3.00B
📈 Top yield: CETES 4.52% · USDY 3.49% · SAFO 3.44%
🔄 7d: eurSAFO +4.75%
...
**Title:** Tokenized money market funds: $10.85B across 15 EU/US funds (2026-08-18)
...
|---|---|---|---|---|
| USYC | $3.00B | 3.16% | -0.34% | 36 |
| BUIDL | $2.71B | 3.42% | 1.17% | 106 |
| USDY | $2.12B | 3.49% | 0.15% | 17276 |
| eurSAFO | $1.10B | 2.19% | 4.75% | 7893 |
| EUTBL | $918.0M | 2.21% | -0.79% | 3800 |

Top yields: CETES 4.52%, USDY 3.49%, SAFO 3.44%, BUIDL 3.42%, USYC 3.16%
Biggest 7d mover: eurSAFO +4.75%, USTBL -5.30%

What the numbers mean: $7.83B (~72%) is in just 3 funds. Yields span 2.44 points (2.08% → 4.52%). USDY has 17,276 holders vs 106 for BUIDL.
...
$10.85B is sitting in tokenized money market funds — and almost nobody can tell you exactly what's inside them.
...
$10.85B across 15 EU + US funds:
• USYC (Circle) — $3.00B · yield 3.16%
• BUIDL (BlackRock) — $2.71B · yield 3.42%
• USDY (Ondo) — $2.12B · yield 3.49%
• eurSAFO (Spiko) — $1.10B · yield 2.19%
• EUTBL (Spiko) — $918.0M · yield 2.21%

Top yields today: CETES 4.52% · USDY 3.49% · SAFO 3.44% · BUIDL 3.42% · USYC 3.16%
...
• Yield on offer runs from 2.08% to 4.52% — a 2.44-point gap for the same "park cash safely" trade. Which treasury you pick is now a real decision.
• USDY counts 17,276 holders; BUIDL counts 106. Same asset class, two worlds: retail wallets vs institutions parking billions.
• eurSAFO is the 7-day mover (+4.75%), while USTBL cooled off (-5.30%). Capital is rotating, not leaving the asset class.
...
• Tx: https://sepolia.etherscan.io/tx/0x8900daf203035d30c1663a0a5ca0c7b2889bd20d5e0221155bc3b67409208431
• Contract: 0xd482a715cdef4073593f4a3208abd328f6d71725
• Hash: 0x94bdf084…

WHAT THE DATA SAYS RIGHT NOW

eurSAFO is the 7-day mover (+4.75%), while USTBL cooled off (-5.30%). The rotation between EUR and USD funds is the story to watch.
